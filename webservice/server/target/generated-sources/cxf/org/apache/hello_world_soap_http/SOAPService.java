 ...
 * 2016-12-24T01:00:41.617+01:00
 * Generated source version: 3.1.9
 * 
 */
@WebServiceClient(name = "SOAPService", 
                  wsdlLocation = "file:/D:/Workspace_FicusBenjamina/webservice/server/src/main/resources/hello_world.wsdl",
...
public class SOAPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Workspace_FicusBenjamina/webservice/server/src/main/resources/hello_world.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOAPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/Workspace_FicusBenjamina/webservice/server/src/main/resources/hello_world.wsdl");
        }
        WSDL_LOCATION = url;
    }
