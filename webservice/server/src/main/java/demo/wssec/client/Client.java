...
public final class Client {
    ...
    public static void main(String args[]) throws Exception {
    	...
    	args[0] = Client.class.getClassLoader().getResource("hello_world.wsdl").getFile().toString();
    	System.out.println(args[0]);
    	args[1] = Client.class.getClassLoader().getResource("properties/wssec-client.xml").getFile().toString();
        ...
        Greeter port = soapService.getSoapPort();
//        
